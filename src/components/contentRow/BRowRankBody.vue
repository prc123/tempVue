      ...
      <div class="r-list-wrapper" ref="listWrapper">
        <ul class="rlist">
          ...
          >
            ...
            <div class="preview">
              <!-- :alt="item.title" -->
              <router-link :to="{name:'video', params:{bvid:item.bvid}}" :title="item.title" target="_blank">
                <img
                  data-img=""
                  :src="item.pic"
                  loaded="loaded"
            ...
            <router-link :to="{name:'video', params:{bvid:item.bvid}}"
              class="rl-info"
            ...
            >
              ...
              <div class="i">
                <b class="pts" :title="item.pts">综合评分：{{ item.pts }} </b>
              </div>
            </router-link>
          </li>
        </ul>
